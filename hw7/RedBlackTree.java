...
public class RedBlackTree<T extends Comparable<T>> {
    ...
    RBTreeNode<T> rotateRight(RBTreeNode<T> node) {
        ...
        if (node.left == null) {
            ...
            RBTreeNode<T> left = new RBTreeNode(node.isBlack, node.item, node.left, node.right);
    ...
    RBTreeNode<T> rotateLeft(RBTreeNode<T> node) {
        ...
        if (node.right == null) {
            ...
            RBTreeNode<T> right = new RBTreeNode(node.isBlack, node.item, node.left, node.right);
