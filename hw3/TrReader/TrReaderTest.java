...
public class TrReaderTest {
    ...
    public void testSource() throws IOException {
        ...
        TrReader trR0 = new TrReader(new StringReader("azbzczdz"), "edcab", "EDCAB");
        char[] cbuf0 = new char[8];
        assertEquals(8,trR0.read(cbuf0));
        String result0 = new String(cbuf0);
        assertEquals("AzBzCzDz", result0);
