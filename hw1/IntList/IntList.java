...
public class IntList {
    ...
    static IntList subTail(IntList L, int start) {
        ...
        M = temp;
        return M; // REPLACE WITH YOUR CODE
    }
    ...
    static IntList sublist(IntList L, int start, int len) {
        ...
        IntList T = new IntList(S.head,null);
        IntList temp = T;
        S = S.tail;
        for(int i = 0;S!=null&&i<len-1;S=S.tail){
            temp.tail = new IntList(S.head,null);
            temp = temp.tail;
            i++;
        }
        return T;// REPLACE WITH YOUR SOLUTION
    }
    ...
    static IntList dsublist(IntList L, int start, int len) {
        ...
        temp.tail = null;
        return S;   // REPLACE WITH YOUR SOLUTION
    }
